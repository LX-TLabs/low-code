...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/2UWE04MGsq)
...
```sh
npx nx serve low-code
```

To create a production bundle:

```sh
npx nx build low-code
```

To see all available targets to run for a project, run:

```sh
npx nx show project low-code
```
